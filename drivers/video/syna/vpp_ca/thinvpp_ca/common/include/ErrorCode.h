...
#define E_AVIF_BASE         ( 0x3000 << 16 )    // AVIF base //200 is used by hdmirx

// #define E_XXX_BASE       ( 0x00a0 << 16 )    // Add your module base here


#if !defined(E_GENERIC_BASE) && !defined(E_SUC) && !defined(E_ERR)
...
#include "errcode_avif.h"
#include "errcode_hdmirx.h"
#else
#include "errcode_vpp.h"
#endif
//...
